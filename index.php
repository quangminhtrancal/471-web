...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#myPage">Tracking @ Home</a>
    </div>
...
<div class="jumbotron text-center">
  <h1>Tracking @Home (Book Edition)</h1>
  <p>Never waste time finding books</p>
</div>

<!-- Container (Overview Section) -->
<div id="overview" class="container-fluid">
  <div class="row">
      <h2>DATABASE STATE</h2><br>
      <h3>There are total of 9 tables, the concatenated table is:</h3>
  </div>
</div>
...
<footer class="container-fluid text-center">
  ...
  <p> Reused Bootstrap Theme Made By <a href="https://www.w3schools.com" title="Visit w3schools">www.w3schools.com</a></p>
</footer>
